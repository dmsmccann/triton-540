...
**Figure 89-1.** PTO and crystal-oscillator waveforms

In Figure 89-1, the PTO emitter is the expected 5.25 MHz, 0.600 Vpp sine wave.
Q89-3's drain contains a 7.50 MHz, 5.57 mVpp waveform. This small drain swing is a consequence
...
The carrier voltage actually applied differentially to U89-1 is shown in
Figure 89-2.

![MC1496 input and raw-output waveforms](spice/studies/80289/signal-walk/figures/80289-vfo-80m-mixer.png)

**Figure 89-2.** MC1496 input and raw-output waveforms
...
**Figure 89-4.** Filter and output-buffer waveforms

In Figure 89-4, the total peak-to-peak waveforms are 96.9 mV at the Q89-1 gate,
78.2 mV at the Q89-1 source, 75.0 mV at the Q89-2 emitter, and 48.8 mV at the 50 Ω-loaded
...
filter shape from frequency-dependent mixer conversion amplitude. Figure 89-5
plots the result.

![Aligned switched-filter AC response](spice/studies/80289/filter-response/figures/80289-vfo-filter-ac-response.png)

**Figure 89-5.** Aligned switched-filter AC response
...
**Figure 89-6.** Switched-output-filter response

The red output trace in Figure 89-6 still slopes because it includes the ideal
source,
...
**Figure 89-7.** R89-2 mixer-balance sweep

The sweep in Figure 89-7 puts the simulated minimum at exactly the saved
setting:
...
U89-1 differential output and final VFO `OUT`. Figure 89-8 plots the sweep.
...
**Figure 89-8.** R89-27 crystal-injection sweep
...
**Figure 89-9.** Band-center FFTs for 80, 40, 20, and 15 meters

In Figure 89-9, the mixed bands show both input-frequency feedthrough and
sum/difference
...
**Figure 89-10.** Band-center FFTs for the four ten-meter segments

For the four ten-meter segments in Figure 89-10, the 5.26 MHz corrected PTO
mixes with the
