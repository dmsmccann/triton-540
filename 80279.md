...
The runner exports a fresh SPICE netlist from `if-agc_80279.kicad_sch`. The
...
The upper traces show the two RF inputs: 9.001 MHz at gate 1 and 9.000 MHz at
...
The horizontal axis is audio frequency. The vertical axis is level in dB
...
The horizontal axis is audio frequency on a logarithmic scale. The vertical
...
The calibrated weak/strong/weak envelope produced:
...
The dashed lines mark the transitions to strong and back to weak. The upper
...
The horizontal axis is modeled voltage at the 80279 input on a logarithmic
...
The top plot shows `R`, `T`, and the Q79-6 base. The middle plot shows stored
AGC and PIN bias. The lower plot shows receive meter current disappearing at
